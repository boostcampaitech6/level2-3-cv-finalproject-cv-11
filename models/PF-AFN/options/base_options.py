...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--name', type=str, default='cloth-warp', help='name of the experiment. It decides where to store samples and models')
        ...
        self.parser.add_argument('--label_nc', type=int, default=13, help='# of input label channels')

        self.parser.add_argument('--dataroot', type=str,
                                 default='/home/rtboa/DCI-VTON-Virtual-Try-On/VITON-HD') 
